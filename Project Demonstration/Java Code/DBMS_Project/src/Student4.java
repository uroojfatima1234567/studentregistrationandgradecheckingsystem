...
public class Student4 extends JFrame {
	...
	public Student4() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try 
				{
					...
					String query="SELECT * from thmarks where std_id=104";
					...
					String query1="SELECT * from labmarks where std_id=104";
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try 
				{
					...
					//Theory GPA
					Conn c=new Conn();	//Object class Conn Database
					String query="SELECT gpa from thmarks where std_id=104";
					ResultSet rs= c.s.executeQuery(query);
					...
					while(rs.next()) 
					{
						...
						//Lab GPA
						Conn c1=new Conn();	//Object class Conn Database
						String query1="SELECT gpa from labmarks where std_id=104";
						...
						String query3="SELECT gpa from cgpa where std_id=104";
		...
		try 
		{
			...
			Conn c=new Conn();	//Object class Conn Database
			String query="SELECT Std_ID, Std_Name from student where std_id=104";
			ResultSet rs= c.s.executeQuery(query);
