...
public class MarksCA extends JFrame {
	...
	public MarksCA() {
		...
		getcourseL.setText("Cmp Arch(Lab)");
		...
		try 
		{
			...
			Conn c=new Conn();	//Object class Conn Database
			String query="SELECT faculty_id, faculty_name, course_name from faculty join courses using(course_id) where course_id=31";
			ResultSet rs= c.s.executeQuery(query);
			
			//Lab course
			Conn c1=new Conn();	//Object class Conn Database
			String query1="SELECT course_name from courses where course_id=311";
