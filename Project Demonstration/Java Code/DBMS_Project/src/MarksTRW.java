...
public class MarksTRW extends JFrame {
	...
	public MarksTRW() {
		...
		try 
		{
			...
			Conn c=new Conn();	//Object class Conn Database
			String query="SELECT faculty_id, faculty_name, course_name from faculty join courses using(course_id) where course_id=201";
			ResultSet rs= c.s.executeQuery(query);
