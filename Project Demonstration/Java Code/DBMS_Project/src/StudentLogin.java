			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(rs.next())
					{
					    ...
					    {
					    	if(Username.equals("101") && Password.equals("123"))
					    	{
					    	...
					    	else if(Username.equals("102") && Password.equals("123"))
					    	{
					    	...
					    	else if(Username.equals("103") && Password.equals("123"))
					    	{
					    	...
					    	else if(Username.equals("104") && Password.equals("123"))
					    	{
					    	...
					    	else if(Username.equals("105") && Password.equals("123"))
					    	{
